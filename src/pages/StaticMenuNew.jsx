...
import { createStaticMenus } from "../components/StaticMenusApiRequest";

export default function StaticMenuNew({ session, dispatchSession }) {
  ...
  async function HandleSubmit(e) {
    ...
    const { status, data } = await createStaticMenus(
